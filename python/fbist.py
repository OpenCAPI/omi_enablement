...
class Fbist:
	...
	steps_fbist_writes = ("steps_fbist_writes",
		...
		'W' ,0x0102000000000030,0x0000000000000000,"FBIST POOL 0 ENGINE 0 ADDRESS START 32b HIGH",
		'W' ,0x0102000000000034,0x0000000000000000,"FBIST POOL 0 ENGINE 1 ADDRESS START 32b LOW",
		'W' ,0x0102000000000038,0x0000000000000001,"FBIST POOL 0 ENGINE 1 ADDRESS START 32b HIGH",
		'W' ,0x010200000000003C,0x0000000000000000,"FBIST POOL 0 ENGINE 2 ADDRESS START 32b LOW",
		'W' ,0x0102000000000040,0x0000000000000002,"FBIST POOL 0 ENGINE 2 ADDRESS START 32b HIGH",
		'W' ,0x0102000000000044,0x0000000000000000,"FBIST POOL 0 ENGINE 3 ADDRESS START 32b LOW",
		'W' ,0x0102000000000048,0x0000000000000003,"FBIST POOL 0 ENGINE 3 ADDRESS START 32b HIGH",
		'W' ,0x010200000000004C,0x0000000000000000,"FBIST POOL 0 ENGINE 4 ADDRESS START 32b LOW",
		'W' ,0x0102000000000050,0x0000000000000004,"FBIST POOL 0 ENGINE 4 ADDRESS START 32b HIGH",
		'W' ,0x0102000000000054,0x0000000000000000,"FBIST POOL 0 ENGINE 5 ADDRESS START 32b LOW",
		'W' ,0x0102000000000058,0x0000000000000005,"FBIST POOL 0 ENGINE 5 ADDRESS START 32b HIGH",
		'W' ,0x010200000000005C,0x0000000000000000,"FBIST POOL 0 ENGINE 6 ADDRESS START 32b LOW",
		'W' ,0x0102000000000060,0x0000000000000006,"FBIST POOL 0 ENGINE 6 ADDRESS START 32b HIGH",
		'W' ,0x0102000000000064,0x0000000000000000,"FBIST POOL 0 ENGINE 7 ADDRESS START 32b LOW",
		'W' ,0x0102000000000068,0x0000000000000007,"FBIST POOL 0 ENGINE 7 ADDRESS START 32b HIGH",
	...
	def fbist_stats_wr(self, _busnum, _ddimm):
		...
		run_low = fire.i2cread(0x010200000000008C + ddimm_add_adj)
		...
		lat_high = fire.i2cread(0x01020000000000B8 + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000B4 + ddimm_add_adj)
		latency_E0 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E0 : {:0>.2f} secs".format(latency_E0))

		lat_high = fire.i2cread(0x01020000000000CC + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000BC + ddimm_add_adj)
		latency_E1 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E1 : {:0>.2f} secs".format(latency_E1))

		lat_high = fire.i2cread(0x01020000000000D4 + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000D0 + ddimm_add_adj)
		latency_E2 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E2 : {:0>.2f} secs".format(latency_E2))

		lat_high = fire.i2cread(0x01020000000000DC + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000D8 + ddimm_add_adj)
		latency_E3 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E3 : {:0>.2f} secs".format(latency_E3))

		lat_high = fire.i2cread(0x01020000000000E4 + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000E0 + ddimm_add_adj)
		latency_E4 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E4 : {:0>.2f} secs".format(latency_E4))

		lat_high = fire.i2cread(0x01020000000000EC + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000E8 + ddimm_add_adj)
		latency_E5 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E5 : {:0>.2f} secs".format(latency_E5))

		lat_high = fire.i2cread(0x01020000000000F4 + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000F0 + ddimm_add_adj)
		latency_E6 = ((lat_low + (lat_high << 32)) / (fire.freq*1E6))
		print("Latency E6 : {:0>.2f} secs".format(latency_E6))

		lat_high = fire.i2cread(0x01020000000000FC + ddimm_add_adj)
		lat_low = fire.i2cread(0x01020000000000F8 + ddimm_add_adj)
		...
		nb_wr_high = fire.i2cread(0x01020000000000A8 + ddimm_add_adj)
		#nb_wr_high =0x0000000000000000 
		#print("nb_wr H :",nb_wr_high)
		nb_wr_low  = fire.i2cread(0x0102000000000080 + ddimm_add_adj)
		...
		nb_32Bwr_high = fire.i2cread(0x01020000000000AC + ddimm_add_adj)
		#nb_32Bwr_high =0x0000000000000000
		#print("nb_32Bwr H :",nb_32Bwr_high)
 
		nb_32Bwr_low  = fire.i2cread(0x0102000000000088 + ddimm_add_adj)
	...
	def fbist_stats_rd(self, _busnum, _ddimm):
		...
		nb_rd_high = fire.i2cread(0x01020000000000A8 + ddimm_add_adj)
		#nb_rd_high =0x0000000000000000 
		#print("nb_rd H :",nb_rd_high)
		nb_rd_low  = fire.i2cread(0x010200000000007c + ddimm_add_adj)
		...
		nb_32Brd_high = fire.i2cread(0x01020000000000AC + ddimm_add_adj)
		#nb_32Brd_high =0x0000000000000000
		#print("nb_32Brd H :",nb_32Brd_high)
 
		nb_32Brd_low  = fire.i2cread(0x0102000000000084 + ddimm_add_adj)
